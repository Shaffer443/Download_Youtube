...
salvar_em = 'C:/Users/rafael.gouveia/Downloads'
def download_video(url, output_path=salvar_em): # output_path=None
    try:
        ...
        if output_path is None: # Cria uma pasta na própría aplicação
